---
description: Implements a .scratch issue end-to-end (code + tests) for EASY, mechanical slices — frontend rendering, CSS, display formatting, simple wiring. Runs on DeepSeek V4 Pro (opencode-go).
mode: subagent
